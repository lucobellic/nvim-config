...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { '<leader>fr', function() recent({ filter = { cwd = true } }) end, desc = 'Find Recent (cwd)' },
      { '<leader>fR', function() recent({ filter = { cwd = false } }) end, desc = 'Find Recent' },
      ...
      { '<leader>sp', function() Snacks.picker.lazy() end, desc = 'Search for Plugin Spec' },
      {
        ...
        desc = 'Search Visual selection or word (Root Dir)',
        mode = { 'n', 'x' },
      },
      {
        '<leader>sW',
        function() Snacks.picker.grep_word({ root = false }) end,
        desc = 'Search Visual selection or word (cwd)',
        mode = { 'n', 'x' },
      },
      -- search
      ...
      { '<leader>s.', function() Snacks.picker.resume() end, desc = 'Search Resume' },
      { '<leader>sq', function() Snacks.picker.qflist() end, desc = 'Search Quickfix List' },
      { '<leader>su', function() Snacks.picker.undo() end, desc = 'Search Undotree' },
      -- ui
