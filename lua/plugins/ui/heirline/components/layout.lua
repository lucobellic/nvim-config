...
local hl_names = {
  'LayoutActiveBottom',
  'LayoutInactiveBottom',
  'LayoutPickActiveBottom',
  'LayoutPickInactiveBottom',
  'LayoutSeparatorActiveBottom',
  'LayoutSeparatorInactiveBottom',
}
...
local LeftAlignment = {
  init = function(self)
    ...
    local mid_section = table.concat(require('layout').get_statusline('bottom'))
...
local Layout = {
  init = function(self) self.text = table.concat(require('layout').get_statusline('bottom')) end,
