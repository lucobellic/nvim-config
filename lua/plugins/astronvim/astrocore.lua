  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ['<E'] = { '[e', desc = 'Previous Error', remap = true },
        ['>E'] = { ']e', desc = 'Next Error', remap = true },
        ['<D'] = { '[d', desc = 'Previous Diagnostic', remap = true },
        ['>D'] = { ']d', desc = 'Next Diagnostic', remap = true },
        ['<W'] = { '[w', desc = 'Previous Warning', remap = true },
        ['>W'] = { ']w', desc = 'Next Warning', remap = true },
