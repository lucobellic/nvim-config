...
local filter_skip = {
  filter = {
    ...
    any = {
      ...
      { event = 'msg_show', kind = 'echomsg'     , find = 'Heads up!'                   } ,
      { event = 'msg_show', kind = 'echoerr'     , find = 'satellite.nvim'              } ,
      { event = 'msg_show', kind = 'search_count', find = 'Pattern found'               } ,
      ...
      { event = 'msg_show', kind = 'lua_error'   , find = 'satellite.nvim'              } ,
