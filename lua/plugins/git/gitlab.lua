return {
  ...
  keys = {
    ...
    { '<leader>glS', function() require('gitlab-nvim').review() end, desc = 'Gitlab Start Review' },
    { '<leader>gls', function() require('gitlab-nvim').summary() end, desc = 'Gitlab Summary' },
    ...
    { '<leader>glad', function() require('gitlab-nvim').delete_assignee() end, desc = 'Gitlab Delete Assignee' },
    { '<leader>glla', function() require('gitlab-nvim').add_label() end, desc = 'Gitlab Add Label' },
    { '<leader>glld', function() require('gitlab-nvim').delete_label() end, desc = 'Gitlab Delete Label' },
    { '<leader>glra', function() require('gitlab-nvim').add_reviewer() end, desc = 'Gitlab Add Reviewer' },
    { '<leader>glrd', function() require('gitlab-nvim').delete_reviewer() end, desc = 'Gitlab Delete Reviewer' },
    { '<leader>glp', function() require('gitlab-nvim').pipeline() end, desc = 'Gitlab Pipeline' },
    { '<leader>glo', function() require('gitlab-nvim').open_in_browser() end, desc = 'Gitlab Open In Browser' },
    { '<leader>glM', function() require('gitlab-nvim').merge() end, desc = 'Gitlab Merge' },
    { '<leader>glu', function() require('gitlab-nvim').copy_mr_url() end, desc = 'Gitlab Copy Mr Url' },
    { '<leader>glP', function() require('gitlab-nvim').publish_all_drafts() end, desc = 'Gitlab Publish All Drafts' },
    { '<leader>glD', function() require('gitlab-nvim').toggle_draft_mode() end, desc = 'Gitlab Toggle Draft Mode' },
  },
  build = function() require('gitlab-nvim.server').build(true) end, -- Builds the Go binary
  --- @type Settings
