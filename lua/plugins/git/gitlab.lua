return {
  ...
  keys = {
    ...
    { '<leader>glc', function() require('gitlab').create_multiline_comment() end, desc = 'Gitlab Create Multiline Comment', mode = { 'n', 'v' }, },
    { '<leader>glC', function() require('gitlab').create_comment_suggestion() end, desc = 'Gitlab Create Comment Suggestion', mode = { 'n', 'v' }, },
    { '<leader>glO', function() require('gitlab').create_mr() end, desc = 'Gitlab Create Mr' },
    { '<leader>glm', function() require('gitlab').move_to_discussion_tree_from_diagnostic() end, desc = 'Gitlab Move To Discussion Tree From Diagnostic', },
