...
vim.keymap.set({ 'n', 't', 'i' }, '<A-l>', '<cmd>OpenCode2Next<cr>', { buffer = true })
vim.keymap.set({ 'n', 't', 'i' }, '<A-h>', '<cmd>OpenCode2Prev<cr>', { buffer = true })
vim.keymap.set({ 'n' }, '<S-l>', '<cmd>OpenCode2Next<cr>', { buffer = true })
vim.keymap.set({ 'n' }, '<S-h>', '<cmd>OpenCode2Prev<cr>', { buffer = true })
vim.keymap.set({ 'n', 't', 'i' }, '<C-q>', '<cmd>OpenCode2Close<cr>', { buffer = true })
vim.keymap.set({ 'n' }, '<C-t>', '<cmd>OpenCode2New<cr>', { buffer = true })
require('util.terminal_clipboard').setup()
