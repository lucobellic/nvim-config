...
vim.keymap.set({ 'n', 't', 'i' }, '<A-l>', '<cmd>ClaudeNext<cr>', { buffer = true })
vim.keymap.set({ 'n', 't', 'i' }, '<A-h>', '<cmd>ClaudePrev<cr>', { buffer = true })
vim.keymap.set({ 'n', 't', 'i' }, '<C-q>', '<cmd>ClaudeClose<cr>', { buffer = true })
vim.keymap.set({ 'n' }, '<C-t>', '<cmd>ClaudeNew<cr>', { buffer = true })
